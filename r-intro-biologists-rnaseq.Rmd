...
#  <img src="images/tidyBulk_logo.png" height="139px" width="120px" />
...
counts.de %>%
  filter(lowly_abundant == FALSE) %>%
  ggplot(aes(x=`logCPM_conditionbpreg - conditionblact`, y=-`logFC_conditionbpreg - conditionblact`, colour=`is_de_conditionbpreg - conditionblact`)) +
  geom_point()
```
### Volcano plots
...
counts.de %>%
  filter(lowly_abundant == FALSE) %>%
  ggplot(aes(x=`logFC_conditionbpreg - conditionblact`, y=-log10(`PValue_conditionbpreg - conditionblact`), colour=`is_de_conditionbpreg - conditionblact`)) +
  geom_point()
```
