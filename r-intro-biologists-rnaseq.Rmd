...
# Intro to ttBulk and tidyHeatmap packages

#  <img src="images/ttbulk_logo.png" height="139px" width="120px" />

In this course we will use some new packages, [**ttBulk**]([https://github.com/stemangiola/ttBulk) and [**tidyHeatmap**](https://github.com/stemangiola/tidyHeatmap). These packages provide a friendly tidyverse-style way to perform analysis of RNA-Seq data.
