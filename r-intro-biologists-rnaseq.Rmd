...
# Key Points
- RNA-seq data can be analysed in a 'tidy' way using the packages ttBulk and tidyHeatmap
...
- Other useful plots for assessing RNA-seq data are density plots, box plots, MA plots, volcano plots, stripcharts and heatmaps
